...
function InfrastructureMonitoring() {
    ...
    useEffect(() => {
        const values = {
            query: "SELECT name,des,wlink,status,image_data,cnt,Data_Center_Infrastructure_and_Infrastructure_Monitoring FROM Vendor WHERE Data_Center_Infrastructure_and_Infrastructure_Monitoring='true' AND status=1 AND cnt=1;",
            key: "Cr6re8VRBm"
        };
                ...
                <div className="container">
                    <div className='row '>
                        <div className="row text headingrow">
                            ...
                            <div className="col-6" data-aos="fade-up" data-aos-delay="100"><p id='topic'>Data Center
                                Infrastructure and Infrastructure Monitoring</p></div>
                            <div className="col-3" data-aos="fade-up" data-aos-delay="100">
                                <hr/>
                            </div>
                        </div>
